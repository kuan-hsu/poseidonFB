	...
	*/
	...
	static this()
	{
		...
		*/
		...
		ShortKey sk6 = { "dupdown", "Duplication Line Down", 805371732 };
		GLOBAL.shortKeys ~= sk6;
		ShortKey sk7 = { "dupup", "Duplication Line Up", 805371730 };
		GLOBAL.shortKeys ~= sk7;
		ShortKey sk8 = { "find", "Find/Replace", 536870982 };
		GLOBAL.shortKeys ~= sk8;
		ShortKey sk9 = { "findinfile", "Find/Replace In Files", 805306438 };
		GLOBAL.shortKeys ~= sk9;
		ShortKey sk10 = { "findnext", "Find Next", 65472 };
		GLOBAL.shortKeys ~= sk10;
		ShortKey sk11 = { "findprev", "Find Previous", 536936384 };
		GLOBAL.shortKeys ~= sk11;
		ShortKey sk12 = { "gotoline", "Goto Line", 536870983 };
		GLOBAL.shortKeys ~= sk12;
		ShortKey sk13 = { "undo", "Undo", 536871002 };
		GLOBAL.shortKeys ~= sk13;
		ShortKey sk14 = { "redo", "Redo", 805306458 };
		GLOBAL.shortKeys ~= sk14;
		ShortKey sk15 = { "comment", "Comment", 536870994 };
		GLOBAL.shortKeys ~= sk15;
		ShortKey sk16 = { "uncomment", "UnComment", 805306450 };
		...
		ShortKey sk19 = { "outlinesearch", "Outline Search", 1073807296 };
			...
			GLOBAL.languageItems["preference"] = new IupString( "Preference" );
				...
				GLOBAL.languageItems["parser"] = new IupString( "Parser" );
					...
					GLOBAL.languageItems["shortcut"] = new IupString( "Short Cut" );
						...
						GLOBAL.languageItems["sc_outlinesearch"] = new IupString( "Outline Search" );
